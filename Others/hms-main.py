...
sroot.iconbitmap('images/logo-only.ico')
spath = "logo-text.png"
simg = ImageTk.PhotoImage(Image.open(spath))
my = Label(sroot,image=simg)
my.image = simg
my.place(x=100,y=200)
# Frame(sroot,height=516,width=5).place(x=520,y=0)
#chilanka
# Label(sroot,text="Hotel Management System ",font='Timesnewroman 14 ',bg='white',fg='black').place(x=400,y=10)
# Label(sroot,text="Developed By -",font='Timesnewroman 12 ',bg='white',fg='black').place(x=535,y=200)
# Label(sroot,text="Ashish Mool",font='Timesnewroman 12 ',bg='white',fg='grey').place(x=535,y=220)
# Label(sroot,text="220417@softwarica.edu.np",font='Timesnewroman 12',bg='white',fg='grey').place(x=535,y=240)
...
def mainroot():
	...
	root.title("Hotel Management System:::Developed by Ashish Mool")
	...
	def rooms():
	    ...
	    #sidebuttons.insert("end", "\n")
		for i in range(1,21):
	            b = Button(b_frame,font='mssherif 10', text="Room %s" % i,bg='white',fg='cyan4',width=100,command=lambda:roomdet(i))
	            sidebuttons.window_create("end", window=b)
	            sidebuttons.insert("end", "\n")
